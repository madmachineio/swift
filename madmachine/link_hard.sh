...
rm -f $BUILD_PATH/lib/swift_static/madmachine/thumbv7em/eabihf/libswiftCore.a

echo "Linking..."
STD_GEN_PATH=$BUILD_PATH/stdlib/public/core/MADMACHINE/thumbv7em/eabihf
...
$ARM_GCC_PATH/bin/arm-none-eabi-ar Dqc $BUILD_PATH/lib/swift_static/madmachine/thumbv7em/eabihf/libswiftCore.a $obj_files
$ARM_GCC_PATH/bin/arm-none-eabi-ranlib -D $BUILD_PATH/lib/swift_static/madmachine/thumbv7em/eabihf/libswiftCore.a
